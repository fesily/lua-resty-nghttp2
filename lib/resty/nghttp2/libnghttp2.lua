...
ffi.cdef [[
    ...
    typedef struct nghttp2_asio_ctx_s nghttp2_asio_ctx;
    typedef struct nghttp2_asio_client_s nghttp2_asio_client;
    typedef struct nghttp2_asio_submit_s nghttp2_asio_submit;
    ...
    int
    nghttp2_asio_client_submit(nghttp2_asio_client *client, nghttp2_asio_submit *submitCtx, bool need_headers,  ngx_lua_sema_t *sem);
    nghttp2_asio_submit *
    nghttp2_asio_submit_new(nghttp2_asio_client *client, const char *_method, const char *_uri,
